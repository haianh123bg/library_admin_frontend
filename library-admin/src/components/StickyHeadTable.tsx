...
export const StickyHeadTable: React.FC<{ books: BookModel[]; handleRemoveBook: any }> = (props) => {
    ...
    const columns: readonly Column[] = [
        ...
        { id: 'updated_at', label: 'Ngày sửa', minWidth: 100 },
        { id: 'weight', label: 'Trọng lượng(kg)', minWidth: 50 },
        { id: 'ratings_star', label: 'Đánh giá', minWidth: 50 },
        { id: 'size', label: 'Kích thước', minWidth: 50 },
    ...
    const handleDelete = (id: number, name: string) => {
        alert(`Bạn có muốn xóa sách`);
        // Add your delete logic here
    };

    return (
        <Paper sx={{ width: '100%', overflow: 'hidden' }}>
            <TableContainer sx={{ maxHeight: 600, maxWidth: '1200px' }}>
